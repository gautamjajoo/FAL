...
def args_parser():
    ...
    parser.add_argument('--num_users', type=int, default=30, help="number of users")
    parser.add_argument('--frac', type=float, default=0.3, help="the fraction of clients")
    ...
    parser.add_argument('--labeled_data_ratio', type=float, default=0.1, help='split ratio:labeled & unlabeled data')
    ...
    parser.add_argument('--num_samples', type=float, default=0.1, help="ratio of data used for active learning")
