...
def args_parser():
    ...
    parser.add_argument('--rounds', type=int, default=20, help="rounds of training")
    ...
    parser.add_argument('--rho', type=float, default=0, help='rho value for fedprox')
    ...
    parser.add_argument('--labeled_data_ratio', type=float, default=0.6, help='split ratio:labeled & unlabeled data')
    ...
    parser.add_argument('--client_epochs', type=int, default=5, help="number of client epochs")
