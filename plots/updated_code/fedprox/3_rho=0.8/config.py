...
def args_parser():
    ...
    parser.add_argument('--rho', type=float, default=0.8, help='rho value for fedprox')
    ...
    parser.add_argument('--client_epochs', type=int, default=10, help="number of client epochs")
